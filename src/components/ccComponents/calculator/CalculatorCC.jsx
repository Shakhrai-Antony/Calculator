...
class CalculatorCC extends React.Component {
    ...
    switch (value) {
      case "=":
        ...
        try {
          ...
          if (
            this.props.expression.match(/[()]/) &&
            this.props.expression.match(/[(]/g).length !==
              this.props.expression.match(/[)]/g).length
          ) {
            throw Error;
          }
      ...
      default:
        ...
        if (
          this.props.expression.length !== 0 &&
          this.props.expression[this.props.expression.length - 1].match(
            /[%*\/\-+]/
          ) &&
          value.match(/[%*\/\-+]/)
        ) {
        ...
        if (
          ...
          this.props.changeExpression(
            this.props.result + this.props.expression + value
          );
        }
        /* eslint-disable */
        if (
  ...
  render() {
    return <KeypadCC handleClick={this.handleClick} theme={this.props.theme} />;
  }
}
